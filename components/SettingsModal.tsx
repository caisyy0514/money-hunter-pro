...
import { X, Save, Plus, Settings2, Sparkles, Key, Target, History } from 'lucide-react';
  ...
  return (
    <>
          ...
          <div className="p-6 border-b border-okx-border flex justify-between items-center bg-okx-card">
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                className="bg-purple-600/20 text-purple-400 border border-purple-600/30 px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-2 hover:bg-purple-600/30 transition-all"
              >
                <History size={14} /> 历史回测
              </button>
      ...
      <BacktestModal 
        ...
        enabledCoins={currentStrategy.enabledCoins}
      />
    </>
  );
};
